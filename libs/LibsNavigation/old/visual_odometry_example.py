...
def load_image(idx):
    file_name = "/Users/michal/Movies/segmentation/kitty_odometry/08/image_0/" + str(idx).zfill(6) + ".png"
...
def render(frame, keypoints, keypoints_prev, trajectory, writer = None):
    ...
    for i in range(len(keypoints)):
        ...
        result_im = cv2.circle(result_im, (int(ax), int(ay)), 2, (0, 1, 0), -1)
...
if __name__ == "__main__":
    ...
    while cap.isOpened():
        ...
        if count%1 == 0:
            ...
            keypoints, keypoints_prev, translation = visual_odometry.step(frame.mean(axis=2).astype(numpy.uint8))
            ...
            render(frame/255.0, keypoints, keypoints_prev, numpy.array(trajectory), writer)
